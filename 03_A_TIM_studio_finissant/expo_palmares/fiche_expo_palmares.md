...
- Thearylou Lach
- Jad Saloumi
![](media/oignon_projection.jpg)
> Photo prise par David Mirza

![](media/site_oignon_schema.jpg)
> https://o-i-g-n-o-n.github.io/Mission-decollage/#/technique/

Pour une personne comme moi qui est intéressé à l'astrologie, le jeu m'a parru intriguant même avant de l'essayer. Après d'avoir essayer le jeu, je peux confirmer que c'était compliqué. Il y avait beaucoup de boutons qui fesait différentes choses et j'oubliais tout le temps quel bouton fait quoi.
...
- Ryan Dufault
- Walid Cheour
![](media/symbiose_vue_ensemble.jpg)
> Photo prise par David Mirza

![](media/site_symbiose_schema.webp)
> https://les-chimistes.github.io/symbiose/#/technique/

Je trouve que ce projet te donne vraiment l'impression que tu est dans un laboratoire en train de préparé une potion. J'aime qu'il n'y avait techniquement pas de limite au jeu (donc tu joues jusqu'à temps que tu perds) et que tu peux jouer avec d'autres personnes. Cependant,
c'est plus difficile à collaborer dans le jeu, car il y a beaucoup de choses qui se passent en même temps et c'est parfois diffcile à savoir qui doit faire quoi.
## 4- Océan Rouge
### Noms des créateurs
- Amira Tounekti
- Kristy Moussally
![](media/ocean-rouge_vue_ensemble.jpg)
> Photo prise par David Mirza

![](media/site_ocean-rouge_schema-cote.png)
> https://deux-intelligence.github.io/deux-neurones/#/technique/

![](media/site_ocean-rouge_schema-face.png)
> https://deux-intelligence.github.io/deux-neurones/#/technique/

Quand j'ai vu la machine d'arcade dont tu pouvais jouer avec, j'étais intrigué. Le fait de jouer un jeu dans une machine d'arcade te donne un peu l'impression de jouer un jeu retro, mais pourtant la qualité du jeu n'est pas en 8-bit. Je trouvais ça amusant d'utiliser la manette de jeu
...
![](media/arbre-en-face_projection.jpg)
> Photo prise Par Marcus Andrew Bastien

![](media/site_arbre-en-face_schema.jpg)
> https://mammouths.github.io/projet/#/technique/ 

Parmis tout les projets, Arbre-en-face étais le projet que j'aimais le moins. L'idée de faire pousser des arbres sur le tableau blanc est rigolo, mais pas très interessant. J'ai constaté qu'il y avait très peu de personne qui experimentait ce projet et c'est dommage. S'il y avait une
