...
Le dispositif est composé d'un écran, des boutons, des microphones et des cibles pour scanner le code sur les bracelets. Tout ces composantes se trouve dans un petit espace dans la sale d'exposition. 
## Type d'installation
Permanante
...
- Des murs
## Expérience vécu
Pendant que je testais tout les dispositifs, je voyais au loin de la lumière orange. J'étais intrigué, donc j'ai décidé de voir qu'est-ce qui se passe. Après d'avoir scanné le code du bracelet sur l'écran, j'ai intéragi avec le module. Je devais sélectionner un combustible en appuyant sur les boutons et ensuite soufler sur des microphones. Quand le l'appareil salumait, j'étais surpris. C'était fascinant à voire. J'ai joué avec le feu, sans joué avec le feu! 
![](media/feu_module.jpg)
> Photo prise par David Mirza

## Ce qui m'a plu
- Le module montre aux enfants comment allumer un feu de façon sécuritaire (sans jouer avec le feu pour de vrai)
- C'est facile à comprendre, même pour un enfant
- Le dispositif est attirant
## Ce que je n'ai pas aimé
- Le module ne marche pas si on joue trop longtemps
